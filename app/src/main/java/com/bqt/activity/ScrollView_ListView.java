...
public class ScrollView_ListView extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv3.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, new String[] { "前", "前", "前", "前", "前", "前", "前", "前", "前", "前",
				"前", "前", "前", "前", "前", "前", "前", "前", "前" }));
		
		linearLayout.addView(lv1, new LayoutParams(600, LayoutParams.WRAP_CONTENT));//小插曲：此时ListView会出现只显示一行的bug
		linearLayout.addView(lv2, new LayoutParams(400, 800));
		if (new Random().nextBoolean()) linearLayout.addView(lv3, new LayoutParams(LayoutParams.MATCH_PARENT, 800));
